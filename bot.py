...
Это закрытая система по трафику и монетизации: без воды, только рабочие шаги.

<b>Что ты получаешь по подписке:</b>
• пошаговые инструкции (прогрев → креатив → залив → Telegram)
• шаблоны/чек-листы и примеры связок
• доступ к закрытому каналу с обновлениями
• чат/комьюнити для вопросов и разборов
...
Здесь лежит всё, что нужно для старта и масштабирования:
• связки и примеры воронок
• креативы/скрипты/оформление
• аналитика и контроль цифр
• ошибки новичков и как их обходить

Ниже — кнопки на закрытый канал и чат 👇"""
    else:
        text = """🧠 <b>Обучение</b>

Это база по переливу трафика: прогрев, креативы, аналитика, переход в Telegram и масштабирование.

<b>После оплаты подписки ты получишь:</b>
• доступ к закрытому каналу + чат
• материалы/инструкции (пошагово)
• обновления и новые разборы

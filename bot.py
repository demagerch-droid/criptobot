...
def kb_training(has_access: bool) -> InlineKeyboardMarkup:
    ...
    if has_access:
        ...
        rows.append([InlineKeyboardButton(text="💬 Перейти в группу (чат/форум)", url=COMMUNITY_GROUP_URL)])
    else:
...
📌 Совет: сохраняй полезные посты, применяй и задавай вопросы в чате 🙂"""
    else:
        text = """🧠 <b>Обучение</b>
